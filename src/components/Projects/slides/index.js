import breddit from "./images/breddit.png";
...
const slides = [
  {
    imgSrc: breddit,
    name: "breddit",
    description: "A reddit clone created using React and Firebase.",
    code: "https://github.com/sher-s7/reddit-clone",
    demo: "https://reddit-clone-a7ea1.web.app/"
  },
  {
    imgSrc: partplanner,
